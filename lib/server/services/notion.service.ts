...
import { getDatabase, getDatabaseDetails, getFormattedCategoryData } from '@/lib/server/notion'
      ...
      subcategories: [
        {
          id: '1-1',
          name: '脚手架工具',
          desc: 'Create React App、Vite、Next.js等项目生成工具',
        },
        {
          id: '1-2',
          name: '开发环境',
          desc: 'VS Code配置、Node.js版本管理、环境变量配置',
        },
        ...
        { id: '1-4', name: '版本控制', desc: 'Git配置、分支策略、提交规范' },
        {
          id: '1-5',
          name: '项目规范',
          desc: 'ESLint、Prettier、EditorConfig配置',
        },
      ],
    },
    {
      ...
      subcategories: [
        {
          id: '2-1',
          name: '设计工具',
          desc: 'Figma、Sketch、Adobe XD等界面设计工具',
        },
        { id: '2-2', name: '原型制作', desc: '交互原型、线框图、用户流程设计' },
        {
          id: '2-3',
          name: '设计系统',
          desc: '组件库设计、设计规范、Token系统',
        },
        { id: '2-4', name: '素材资源', desc: '图标库、插画、字体、配色方案' },
        {
          id: '2-5',
          name: '设计规范',
          desc: '响应式设计、无障碍设计、交互规范',
        },
      ],
    },
    {
      ...
      subcategories: [
        { id: '3-1', name: '核心框架', desc: 'React、Vue、Angular等前端框架' },
        {
          id: '3-2',
          name: 'UI组件库',
          desc: 'Ant Design、Material-UI、Chakra UI等',
        },
        {
          id: '3-3',
          name: '状态管理',
          desc: 'Redux、Zustand、Recoil等状态管理方案',
        },
        {
          id: '3-4',
          name: '路由导航',
          desc: 'React Router、Vue Router等路由解决方案',
        },
        {
          id: '3-5',
          name: '样式方案',
          desc: 'CSS-in-JS、Tailwind CSS、SCSS等样式方案',
        },
        {
          id: '3-6',
          name: '代码规范',
          desc: 'ESLint、Prettier、Husky等代码规范工具',
        },
      ...
      subcategories: [
        {
          id: '4-1',
          name: '表单处理',
          desc: '表单验证、动态表单、复杂表单交互',
        },
        {
          id: '4-2',
          name: '数据处理',
          desc: '搜索、分页、排序、筛选等数据操作',
        },
        {
          id: '4-3',
          name: '权限管理',
          desc: '角色权限、路由守卫、按钮级权限控制',
        },
        {
          id: '4-4',
          name: '文件处理',
          desc: '文件上传、下载、预览、压缩等功能',
        },
        {
          id: '4-5',
          name: '数据可视化',
          desc: 'ECharts、D3.js、Chart.js等图表库',
        },
      ],
    },
    {
      ...
      subcategories: [
        {
          id: '5-1',
          name: '调试工具',
          desc: 'Chrome DevTools、React DevTools等调试工具',
        },
        {
          id: '5-2',
          name: '单元测试',
          desc: 'Jest、Vitest、Testing Library等测试框架',
        },
        {
          id: '5-3',
          name: 'E2E测试',
          desc: 'Cypress、Playwright、Puppeteer等端到端测试',
        },
        {
          id: '5-4',
          name: '代码质量',
          desc: 'SonarQube、CodeClimate等代码质量检测',
        },
        {
          id: '5-5',
          name: '性能分析',
          desc: 'Lighthouse、Web Vitals、性能监控工具',
        },
        {
          id: '5-6',
          name: '错误追踪',
          desc: 'Sentry、Bugsnag等错误监控和追踪',
        },
      ],
    },
    {
      ...
      subcategories: [
        {
          id: '6-1',
          name: '构建工具',
          desc: 'Webpack、Vite、Rollup等模块打包工具',
        },
        {
          id: '6-2',
          name: 'CI/CD',
          desc: 'GitHub Actions、GitLab CI、Jenkins等持续集成',
        },
        {
          id: '6-3',
          name: '部署平台',
          desc: 'Vercel、Netlify、AWS、阿里云等部署平台',
        },
      ...
      subcategories: [
        {
          id: '7-1',
          name: '性能监控',
          desc: 'Web Vitals、Real User Monitoring、APM工具',
        },
        {
          id: '7-2',
          name: '日志管理',
          desc: 'ELK Stack、Fluentd等日志收集分析工具',
        },
        {
          id: '7-3',
          name: '用户分析',
          desc: 'Google Analytics、百度统计等用户行为分析',
        },
        {
          id: '7-4',
          name: '错误监控',
          desc: '实时错误报警、错误分析、问题定位',
        },
        {
          id: '7-5',
          name: '安全防护',
          desc: 'HTTPS配置、CSP策略、XSS防护等安全措施',
        },
      ],
    },
    {
      ...
      subcategories: [
        {
          id: '8-1',
          name: 'AI开发工具',
          desc: 'GitHub Copilot、Cursor、Codeium等AI编程助手',
        },
        {
          id: '8-2',
          name: 'AI功能集成',
          desc: '聊天机器人、文本处理、图像处理等AI功能',
        },
        {
          id: '8-3',
          name: 'AI框架工具',
          desc: 'Vercel AI SDK、提示词工程等AI开发框架',
        },
      ],
    },
    {
      ...
      subcategories: [
        { id: '9-1', name: '官方文档', desc: '各种技术栈的官方文档和最佳实践' },
        {
          id: '9-2',
          name: '学习资源',
          desc: '教程、视频课程、技术博客、开源项目',
        },
        {
          id: '9-3',
          name: '社区交流',
          desc: 'Stack Overflow、GitHub、技术论坛',
        },
